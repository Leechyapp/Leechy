        ...
        <div className={css.overlapGroup}>
          <div className={css.backdropWrapper}>
            <div className={css.contentWrapper}>
              ...
              <div className={css.searchFormBackground}>
                <div className={css.row}>
                  <div className={css.colInputs}>
                    ...
                    <div className={css.categoryDropdownWrapper}>
                      ...
                      >
                        <option value="" className={css.categoryPlaceholder}>
                          {intl.formatMessage({
                            id: 'LandingPageHeroSection.category.placeholder',
                          })}
                        </option>
                  ...
                  <div className={css.colSearchButton}>
                    <button className={css.searchButton} onClick={() => redirectToSearchPage()}>
...
export default LandingPageHeroSectionDesktop;
